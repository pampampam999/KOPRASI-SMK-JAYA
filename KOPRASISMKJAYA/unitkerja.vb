Public Class unitkerja
    Private Sub unitkerja_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tampil()
        autokode()
    End Sub
    Sub autokode()
        ...
        cmd.CommandText = "select max(kd_unit_kerja) as autokode from unitkerja"
        ...
        Else
            ...
            TextBox1.Text = "U" & auto & ""
        End If
    End Sub
    Sub tampil()
        konek()
        DA = New SqlClient.SqlDataAdapter("select * from unitkerja", conn)
        DS = New DataSet
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox1.Text = "" Or TextBox2.Text = "" Then
            ...
            Exit Sub
        End If
        Dim simpan As String = "insert into unitkerja values ('" & TextBox1.Text & "','" & TextBox2.Text & "')"
        jalankansql(simpan)
        tampil()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "" Or TextBox2.Text = "" Then
            ...
            Exit Sub
        End If
        Dim ubah As String = "update unitkerja set unit_kerja='" & TextBox2.Text & "' where kd_unit_kerja='" & TextBox1.Text & "' "
        jalankansql(ubah)
        tampil()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If vbYes Then
            Dim hapus As String = "delete from unitkerja where kd_unit_kerja='" & TextBox1.Text & "' "
            jalankansql(hapus)
